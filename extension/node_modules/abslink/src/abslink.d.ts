 ...
 */
type RemoteProperty<T> = T extends Function | ProxyMarked ? Remote<T> : T extends object ? Promisify<T> & {
...
export type Remote<T> = RemoteObject<T> & (T extends (...args: infer TArguments) => infer TReturn ? (...args: {
    ...
    [I in keyof TArguments]: UnproxyOrClone<TArguments[I]>;
}) => Remote<TInstance> & Promisify<Remote<TInstance>> : unknown) & ProxyMethods;
/**
 ...
 */
export declare const transferHandlers: Map<string, TransferHandler<any, any>>;
export declare function expose<T extends object>(obj: T, ep: Endpoint, rootMarkerID?: number): T;
export declare function wrap<T>(endpoint: Endpoint, rootMarkerID?: number): Remote<T>;
